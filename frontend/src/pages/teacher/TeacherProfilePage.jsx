...
export const TeacherProfilePage = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 600 }}>
      ...
      <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #fde68a', padding: 24, display: 'flex', alignItems: 'center', gap: 20 }}>
        <div style={{ position: 'relative' }}>
          <div style={{ width: 80, height: 80, background: ACCENT, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', border: '3px solid #fde68a' }}>
        ...
        <div>
          ...
          <span style={{ fontSize: 11, fontWeight: 600, padding: '2px 10px', borderRadius: 99, background: '#fef3c7', color: ACCENT, display: 'inline-block', marginTop: 6 }}>Profesor</span>
        </div>
      </div>

      <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #fde68a', padding: 24 }}>
